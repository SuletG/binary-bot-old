...
Blockly.Blocks.report = {
    init: function init() {
        ...
        this.appendValueInput('PROFIT')
            ...
            .appendField(`${translate('Contract Profit')}:`);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(theme.subBlockColor);
        this.setTooltip(
            translate(
                'Show some statistics from the running. Lowest and Highest stake, winning and losing streaks, time running, runs, win rate'
            )
        );
    },
