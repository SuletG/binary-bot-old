...
Blockly.Blocks.virtual_config = {
    init: function init() {
        ...
        this.appendValueInput('STATUS')
            ...
            .appendField(`${translate('Status')}:`);
        this.appendValueInput('TOKEN')
            .setCheck('String')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Demo Account Token')}:`);
        this.appendValueInput('MAXSTEPS')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Max Steps')}:`);
        this.appendValueInput('STEPSCOUNT')
            .setCheck('Boolean')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Count steps on loss')}:`);
        this.appendValueInput('RESETTYPE')
            .setCheck('Boolean')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Reset steps')}:`);
        this.appendValueInput('MINREAL')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Min. Trades on Real')}:`);
        this.appendValueInput('MAXREAL')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Max. Trades on Real')}:`);
        this.appendValueInput('BACKREAL')
            .setCheck('Boolean')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Go Back to Virtual on Win')}:`);
