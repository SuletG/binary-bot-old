...
Blockly.Blocks.masaniello_tradedefinitions = {
    init: function init() {
        ...
        this.appendValueInput('TRADES')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Max Number of Trades')}:`);
        this.appendValueInput('BALANCE')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Initial Balance')}:`);
        this.appendValueInput('PAYOUT')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Payout Percentage')}:`);
        this.appendValueInput('WINRATE')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Target Winrate %')}:`);
