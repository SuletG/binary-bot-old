...
Blockly.Blocks.binarymartingale_tradedefinitions = {
    init: function init() {
        ...
        this.appendValueInput('USECUMULATIVE')
            .setCheck('Boolean')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Use Cumulative')}:`);
...
Blockly.JavaScript.binarymartingale_tradedefinitions = block => {
    ...
    const useCumulative =
        Blockly.JavaScript.valueToCode(block, 'USECUMULATIVE', Blockly.JavaScript.ORDER_ATOMIC) || false;
