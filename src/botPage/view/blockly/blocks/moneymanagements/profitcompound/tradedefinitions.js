...
Blockly.Blocks.profitcompound_tradedefinitions = {
    init: function init() {
        ...
        this.appendValueInput('PERCENTAGE')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Percentage of the profit to be applied')}:`);
        this.appendValueInput('MAXSTEPS')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Max times applying profit before reset')}:`);
        this.appendValueInput('RESTART')
            .setCheck('Boolean')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Reset the applied profit count on loss')}:`);
