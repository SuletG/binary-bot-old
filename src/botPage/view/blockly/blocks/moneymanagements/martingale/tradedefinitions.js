...
Blockly.Blocks.martingale_tradedefinitions = {
    init: function init() {
        this.appendDummyInput().appendField(translate('Martingale Run Once at Start'));
        this.appendValueInput('INITIAL')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Initial Stake')}:`);
        this.appendValueInput('FACTOR')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Factor')}:`);
        this.appendValueInput('MAXSTEPS')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Max Steps')}:`);
        this.appendValueInput('STARTAFTER')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Start Applying Factor After')}:`);
        this.appendValueInput('RESET')
            .setCheck('Boolean')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('At Max Steps Reset Stake')}:`);
        this.setColour(theme.subBlockColor);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(translate('Setup block of the Martingale money management'));
    },
...
Blockly.JavaScript.martingale_tradedefinitions = block => {
    ...
    return `
Bot.martingaleTradeDefinitions({initial:${initial}, factor:${factor}, maxsteps:${maxsteps}, startafter:${startafter}, reset:${reset}});`;
};

// WEBPACK FOOTER //
// ./src/botPage/view/blockly/blocks/moneymanagements/martingale/tradedefinitions.js
