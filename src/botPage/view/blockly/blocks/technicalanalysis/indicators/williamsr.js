...
Blockly.Blocks[mod] = {
    init: function init() {
        this.appendDummyInput()
            .appendField(translate('Williams %R (W%R)'))
        ...
        this.setTooltip(translate('Calculates the Williams %R (W%R) from a list of candles with a period'));
        if (this.isInFlyout) {
...
// WEBPACK FOOTER //
// ./src/botPage/view/blockly/blocks/technicalanalysis/indicators/williamsr.js
