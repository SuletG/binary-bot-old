...
Blockly.Blocks[mod] = {
    init: function init() {
        this.appendDummyInput()
            .appendField(translate('Rate Of Change (ROC)'))
        ...
        this.setTooltip(translate('Calculates the Rate Of Change (ROC) from a list with a period'));
        if (this.isInFlyout) {
...
// WEBPACK FOOTER //
// ./src/botPage/view/blockly/blocks/technicalanalysis/indicators/roc.js
