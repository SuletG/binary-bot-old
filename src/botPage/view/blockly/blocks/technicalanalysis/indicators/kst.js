...
Blockly.Blocks[mod] = {
    init: function init() {
        ...
        this.appendValueInput('ROCPERIOD1')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('ROC Period 1')}:`);
        this.appendValueInput('ROCPERIOD2')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('ROC Period 2')}:`);
        this.appendValueInput('ROCPERIOD3')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('ROC Period 3')}:`);
        this.appendValueInput('ROCPERIOD4')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('ROC Period 4')}:`);
        this.appendValueInput('SMAPERIOD1')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('SMA Period 1')}:`);
        this.appendValueInput('SMAPERIOD2')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('SMA Period 2')}:`);
        this.appendValueInput('SMAPERIOD3')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('SMA Period 3')}:`);
        this.appendValueInput('SMAPERIOD4')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('SMA Period 4')}:`);
        this.appendValueInput('SIGNALPERIOD')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Signal Period')}:`);
...
Blockly.JavaScript[mod] = block => {
    ...
    return [
        `Bot.${mod}({values: ${input}, ROCPer1: ${rocperiod1}, ROCPer2:${rocperiod2}, ROCPer3:${rocperiod3}, ROCPer4: ${rocperiod4}, SMAROCPer1: ${smaperiod1}, SMAROCPer2: ${smaperiod2}, SMAROCPer3:${smaperiod3}, SMAROCPer4:${smaperiod4}, signalPeriod:${signalperiod}}, '${field}', '${returnType}')`,
