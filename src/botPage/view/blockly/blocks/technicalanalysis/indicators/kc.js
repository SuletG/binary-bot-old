...
Blockly.Blocks.kc = {
    init: function init() {
        this.appendDummyInput()
            .appendField(translate('Keltner Channels (KC)'))
            .appendField(new Blockly.FieldDropdown(config.bbResult), 'BBRESULT_LIST')
            .appendField(new Blockly.FieldDropdown(config.returnList), 'RETURNKC');
        this.appendValueInput('INPUT')
            .setCheck('Array')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Input Candles')}:`);
        this.appendValueInput('ATRPERIOD')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('ATR Period')}:`);
        this.appendValueInput('MULTIPLIER')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Multiplier')}:`);
        this.appendValueInput('MAPERIOD')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('MA Period')}:`);
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Use SMA')}`)
            .appendField(new Blockly.FieldCheckbox('false'), 'USESMA');
...
Blockly.JavaScript.kc = block => {
    ...
    return [
        `Bot.kc({maPeriod: ${maPeriod}, useSMA: ${useSMA}, multiplier: ${multiplier}, atrPeriod: ${atrPeriod}}, ${candles}, '${kcResult}', '${returnType}')`,
