...
Blockly.Blocks[mod] = {
    init: function init() {
        ...
        this.appendValueInput('INPUT')
            ...
            .appendField(`${translate('Candle List')}:`);
        this.appendValueInput('CONVERSIONPERIOD')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Conversion Period')}:`);
        this.appendValueInput('BASEPERIOD')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Base Period')}:`);
        this.appendValueInput('SPANPERIOD')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Span Period')}:`);
        this.appendValueInput('DISPLACEMENT')
            .setCheck('Number')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(`${translate('Displacement')}:`);
...
Blockly.JavaScript[mod] = block => {
    ...
    const conversionPeriod =
        Blockly.JavaScript.valueToCode(block, 'CONVERSIONPERIOD', Blockly.JavaScript.ORDER_ATOMIC) || '9';
    ...
    return [
        `Bot.${mod}({conversionPeriod: ${conversionPeriod},basePeriod: ${basePeriod},spanPeriod: ${spanPeriod},spanPeriod:${displacement}},${input},'${field}', '${returnType}')`,
