...
Blockly.Blocks.cross = {
    init: function init() {
        ...
        this.appendValueInput('INPUT1')
            ...
            .appendField(translate('Input List 1'));
        this.appendValueInput('INPUT2')
            .setCheck('Array')
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(translate('Input List 2'));
        ...
        this.setTooltip(
            translate(
                'Check if the Source List 1 crossed under/over Source List 2. Using index 1 will check the most recent value of each list'
            )
        );
    },
...
Blockly.JavaScript.cross = block => {
    ...
    return [
        `Bot.checkCross({ index:${index}, input1:${input1}, input2:${input2}, type:"${type}"})`,
