...
Blockly.Blocks.support_resistance = {
    init: function init() {
        ...
        this.setTooltip(
            translate('Get support level based on the amount of candles/ticks, the period, and the time interval.')
        );
...
Blockly.JavaScript.support_resistance = block => {
    ...
    return [
        `Bot.getSupportResistance({index: ${index}, field: '${field}', source: '${source}', period: ${period}, granularity: ${granularity}})`,
