...
Blockly.Blocks.amount_of_ticks_direction = {
    init: function init() {
        ...
        this.appendDummyInput().appendField(
            new Blockly.FieldDropdown(config.lists.CHECK_DIRECTION.slice(0, 2)),
            'CHECK_DIRECTION'
        );
        ...
        this.setTooltip(
            translate('Returns the amount of ticks in the selected direction in the selected amount of ticks')
        );
    },
...
Blockly.JavaScript.amount_of_ticks_direction = block => {
    ...
    return [
        `Bot.amountOfTicksDirection({direction: '${checkWith}', amount:${amount} })`,
