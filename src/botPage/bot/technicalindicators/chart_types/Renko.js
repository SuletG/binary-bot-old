...
class Renko extends Indicator {
    ...
    nextValue(price) {
        console.error(
            'Cannot calculate next value on Renko, Every value has to be recomputed for every change, use calcualte method'
        );
        return null;
    }
}
...
// WEBPACK FOOTER //
// ./src/botPage/bot/technicalindicators/chart_types/Renko.js
